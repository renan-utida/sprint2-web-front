...
import SobreFormulaE from "../../assets/images/info-formulae.png"
import PrimeiroCampeao from "../../assets/images/primeiro-campeao.png"
import DiferencialFormulaE from "../../assets/images/diferencial.png"
import InovacaoFormulaE from "../../assets/images/inovacao-formulae.png"
import AttackMode from "../../assets/images/attack-mode.png"
import ContribuicaoFuturo from "../../assets/images/carro-eletrico.png"
import Gen3Evo from "../../assets/images/gen-evo.png"
import BrasileiroFormulaE from "../../assets/images/brasileiro-formulae.png"
    ...
    const perguntasRespostas = [
        {
            ...
            resposta: (
                <div>
                    ...
                    <img className="img-sobre-fe" src={SobreFormulaE} alt="Corrida de Fórmula" />
                </div>
            ),
        },
        {
            ...
            resposta: (
                <div>
                    ...
                    <img className="primeiro-campeao" src={PrimeiroCampeao} alt="Nelsinho Piquet - Primeiro Campeao da Formula E" />
                </div>
            ),
        },
        {
            ...
            resposta: (
                <div>
                    <p>Os carros da Fórmula E são equipados com baterias elétricas recarregáveis que representam a principal fonte de energia para as corridas. Já relacionado as corridas, elas ocorrem em circuitos de rua em grandes cidades ao redor do mundo, proporcionando uma experiência única para os fãs que podem ver os carros em ação bem de perto.</p>
                    ...
                    <img className="diferencial-img" src={DiferencialFormulaE} alt="Diferencial - Circuito de Rua" />
                </div>
            ),
        },
        {
            ...
            resposta: (
                <div>
                    ...
                    <img className="inovacao-img" src={InovacaoFormulaE} alt="Corrida Fórmula E" />
                </div>
            ),
        },
        {
            ...
            resposta: (
                <div>
                    ...
                    <img className="attack-mode" src={AttackMode} alt="Attack Mode em corrida" />
                </div>
            ),
        },
        {
            ...
            resposta: (
                <div>
                    ...
                    <img className="contribuicao-futuro" src={ContribuicaoFuturo} alt="Contribuição da formula E para o futuro dos carros eletricos" />
                </div>
            ),
        },
        {
            ...
            resposta: (
                <div>
                    ...
                    <img className="gen3-evo" src={Gen3Evo} alt="Gen3 Evo 2024/2025" />
                </div>
            ),
        },
        {
            ...
            resposta: (
                <div>
                    ...
                    <img className="lucas-di-grassi" src={BrasileiroFormulaE} alt="Piloto brasileiro Lucas Di Grassi" />
                </div>
            ),
        },
    ];
